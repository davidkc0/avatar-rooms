...
export declare function startAd(
...
export declare function isSpectator(): boolean;
export declare function myPlayer(): PlayerState;
export declare function getSpectators(): Record<string, PlayerState>;
export declare function getParticipants(): Record<string, PlayerState>;
...
export declare function useMultiplayerState<T = any>(
  key: string,
  defaultValue: T
): MultiplayerStateHookResult<T>;

export declare function usePlayerState<T = any>(
  player: PlayerState,
  key: string,
  defaultValue: T
): MultiplayerStateHookResult<T>;
...
export declare function useSpectatorsList(
  triggerOnPlayerStateChange?: boolean
): PlayerState[];

export declare function useParticipantsList(
  triggerOnPlayerStateChange?: boolean
): PlayerState[];
...
export declare function useSpectatorsState(key: string): PlayerStateWithValue[];

export declare function useParticipantsState(key: string): PlayerStateWithValue[];
...
export declare function getDiscordClient(): DiscordSDK | undefined;
...
export declare function getDiscordAccessToken(): string | undefined;

export declare function getDiscordAuth():
  | {
      access_token: string;
      user: {
        username: string;
...
export declare function getDiscordSDK(): Promise<any>;
